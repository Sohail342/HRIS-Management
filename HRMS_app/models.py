...
class FunctionalGroup(models.Model):
    ...
    group = models.ForeignKey(Group, on_delete=models.CASCADE, related_name='functional_groups')
...
class Employee(models.Model):
    ...
    employee_grade = models.ForeignKey(EmployeeGrade, on_delete=models.SET_NULL, null=True)
